        ...
        return try await withThrowingTaskGroup(of: UIImage?.self) { group in
            ...
            for urlString in urlStrings {
                group.addTask {
                    ...
                    //if we add a ? after try, this means that result of fetchImage is optional, meaning that if we have 50 tasks, and 1 not completes, others still do
