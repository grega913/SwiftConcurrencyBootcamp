...
final class RestaurantManager {
    ...
    func getAllrestaurants() async throws -> [Restaurant] {
        ...
        [
            ...
            Restaurant(id: "4", title: "Local", cuisine: .american),
            Restaurant(id: "5", title: "Pizza Rulz", cuisine: .italian),
            Restaurant(id: "6", title: "Amamamama", cuisine: .japanese),
            Restaurant(id: "7", title: "SteakPolicy", cuisine: .american),
            Restaurant(id: "8", title: "BurgerShack2", cuisine: .american)
        ]
    }
...
final class SearchableViewModel: ObservableObject {
    ...
    func getSearchSuggestions()-> [String] {
        ...
        if search.contains("pi") {
            suggestions.append("Pizza")
        }
